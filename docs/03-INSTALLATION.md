...
# Composio (Optional - for WhatsApp, Facebook, Instagram, and YouTube)
COMPOSIO_API_KEY=...
COMPOSIO_PROJECT_ID=...
COMPOSIO_FACEBOOK_AUTH_CONFIG_ID=ac_...
COMPOSIO_INSTAGRAM_AUTH_CONFIG_ID=ac_...
COMPOSIO_YOUTUBE_AUTH_CONFIG_ID=ac_...
COMPOSIO_ENABLE_FACEBOOK=true
COMPOSIO_ENABLE_INSTAGRAM=true
COMPOSIO_ENABLE_YOUTUBE=true
```
